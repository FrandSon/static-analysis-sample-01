...
public class PubPricesTest {
  ...
  class MultipleDrinks {
    ...
    public void testCanOrderMoreThanTwoBeers() throws Exception {
      int cost = pub.computeCost(Pub.ONE_BEER, false, 3);
      // Añadimos una aserción estricta de JUnit para validar el comportamiento lógico
      org.junit.jupiter.api.Assertions.assertEquals(222, cost);
    }
